...
enUsBlog <- readLines('data/en_US.blogs.txt',skipNul = TRUE)
enUsTwit <- readLines('data/en_US.twitter.txt',skipNul = TRUE)
enUsNews <- readLines('data/en_US.news.txt',skipNul = TRUE)
...
profdictionary <- scan(profanity_url, "")
set.seed(1234)
